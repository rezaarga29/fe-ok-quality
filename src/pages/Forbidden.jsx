...
const WA_MESSAGE = encodeURIComponent(
  "Halo Admin, saya membutuhkan akses ke aplikasi OK Quality RS Urip Sumoharjo. Mohon bantuannya."
);
...
export default function ForbiddenPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#1b4332] via-[#2d6a4f] to-[#40916c] relative overflow-hidden px-4">
      ...
      {/* Decorative blobs */}
      <div className="absolute top-[-100px] left-[-100px] w-[400px] h-[400px] bg-white/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-[-100px] right-[-100px] w-[400px] h-[400px] bg-white/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-[30%] right-[5%] w-[180px] h-[180px] bg-red-400/10 rounded-full blur-2xl pointer-events-none" />
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-8 sm:p-10 shadow-2xl text-center">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-[#95d5b2]/50 rounded-2xl blur-xl scale-125 pointer-events-none" />
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-2xl p-2.5 sm:p-3 shadow-xl">
                <img
                  src={logoImage}
                  alt="Logo OK Quality"
          ...
          {/* Heading */}
          <h1 className="text-2xl sm:text-3xl font-extrabold text-white mb-2 tracking-tight drop-shadow">
            Akses Ditolak
          </h1>
          <p className="text-white/65 text-xs sm:text-sm mb-8 leading-relaxed">
            Akun Anda tidak memiliki izin untuk menggunakan aplikasi{" "}
            <span className="font-semibold text-white/80">OK Quality</span>.
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-sm sm:text-base transition-all duration-150 shadow-[0_8px_32px_rgba(0,0,0,0.25)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.35)] hover:scale-[1.02] active:scale-[0.97]"
            >
